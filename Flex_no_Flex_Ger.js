...
let expInfo = {'participant': '', 'session': '001', 'gender': ''};
...
function experimentInit() {
  ...
  Instructions = new visual.TextStim({
    win: psychoJS.window,
    name: 'Instructions',
    text: 'Bem-vind@, \n\nDurante esta tarefa irás ler frases. Peço-te que leias e que respondas com a máxima atenção com aquilo que achas que corresponde ao Português Europeu Padrão. As respostas que darás estão organizadas numa escala de valores organizadas de 1 a 5. \n\n1 - Discordo totalmente. \n2 - Discordo.\n3 - Neutro.\n4 - Concordo. \n5 - Concordo totalmente. \n\nCarrega na tecla de espaço para continuar.',
    font: 'Arial',
    units: 'height', 
